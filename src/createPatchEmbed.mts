...
import { getNotificationRole, getNotificationsChannel } from './db/index.mjs';
...
export const createPatchEmbed = async ({
  ...
  if (shouldMentionRole) {
    ...
    if (notificationsChannel) {
      const notificationRole = getNotificationRole({ channelId: notificationsChannel.channelId });
